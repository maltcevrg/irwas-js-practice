...
const changeModalState = (state) => {
    const windowForm = document.querySelectorAll(".balcon_icons_img"), windowWidth = document.querySelectorAll("#width"), windowHeight = document.querySelectorAll("#height"), windowProfile = document.querySelectorAll(".checkbox"), windowType = document.querySelectorAll("#view_type");
